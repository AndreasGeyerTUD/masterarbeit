...
from tensorflow.keras.layers import Input, Reshape, Dense, Activation, Dropout, Flatten, BatchNormalization, \
    UpSampling1D, Conv1D, LeakyReLU
...
def train(GAN, G, D, epochs=1000, n_samples=20000, noise_dim=10, batch_size=32, verbose=False, v_freq=50):
    d_loss = []
    g_loss = []
